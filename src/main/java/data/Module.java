...
public class Module {
	...
	public  void calcCond(Commits commitsAll, String[] intervalCommit) {
		int cond=0;
		List<CommitOnModule> commitOnModules = calcCommitOnModulesInInterval(commitsAll, intervalCommit);
		for(int i=0;i<commitOnModules.size();i++) {
			CommitOnModule commitOnModule = commitOnModules.get(i);
			List<SourceCodeChange> changes = identifyChanges(commitsAll, commitOnModule);
	...
	public  List<CommitOnModule> calcCommitOnModulesInInterval(Commits commitsAll,  String[] intervalCommit){
	...
	public  List<SourceCodeChange> identifyChanges(Commits commitsAll, CommitOnModule commitOnModule){
